...
@ManagedBean
@ViewScoped
public class CanceledBookingManagedBean implements Serializable {
    ...
    public void init() {
        ...
        checkIn = new Date();
        checkOut = new Date();
        bookings=bookingService.getCanceledBookings(null,null);
        today = new Date();
    ...
    public void delete() {
        ...
        bookings = bookingService.getCanceledBookings(checkIn,checkOut);
