...
class BookingRepositoryImpl implements BookingRepository {
    ...
    private static final String GET_CHECKED_IN_BOOKINGS = "select  booking_id,bs.booking_status_id,check_in,b.is_valid,check_out,price,b.updated_on,b.created_on,persons_number,status_name remarks,status_name, \n" +
    ...
    public List<Booking> getCheckedInBookings(Date checkIn, Date checkOut) {
        ...
        String queryString = GET_CHECKED_IN_BOOKINGS;
